...
// import {IHelloWorldTaskManager} from "../src/IHelloWorldTaskManager.sol";
...
//     IServiceManager public helloWorldServiceManagerImplementation;

//     HelloWorldTaskManager public helloWorldTaskManager;
//     IHelloWorldTaskManager
//         public helloWorldTaskManagerImplementation;
...
//             )
//         );
//         helloWorldTaskManager = HelloWorldTaskManager(
//             address(
//                 new TransparentUpgradeableProxy(
//                     address(emptyContract),
//                     address(helloWorldProxyAdmin),
...
//         helloWorldTaskManagerImplementation = new HelloWorldTaskManager(
//             registryCoordinator,
...
//         helloWorldProxyAdmin.upgradeAndCall(
//             TransparentUpgradeableProxy(
//                 payable(address(helloWorldTaskManager))
//             ),
//             address(helloWorldTaskManagerImplementation),
//             abi.encodeWithSelector(
//                 helloWorldTaskManager.initialize.selector,
//                 helloWorldPauserReg,
//                 helloWorldCommunityMultisig,
//                 AGGREGATOR_ADDR,
//                 TASK_GENERATOR_ADDR
...
//             deployed_addresses,
//             "HelloWorldTaskManager",
//             address(helloWorldTaskManager)
//         );
//         vm.serializeAddress(
//             deployed_addresses,
//             "HelloWorldTaskManagerImplementation",
//             address(helloWorldTaskManagerImplementation)
//         );
//         vm.serializeAddress(
//             deployed_addresses,

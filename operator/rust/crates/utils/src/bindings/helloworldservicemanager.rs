        ...
        impl alloy_sol_types::SolStruct for Task {
            ...
            fn eip712_root_type() -> alloy_sol_types::private::Cow<'static, str> {
                alloy_sol_types::private::Cow::Borrowed(
                    "Task(string name,uint32 taskCreatedBlock)",
                )
            }
            #[inline]
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IHelloWorldServiceManagerInstance<
        T,
        P,
...
```*/
    ...
    const _: () = {
        use alloy::sol_types as alloy_sol_types;
        {
            ...
            #[automatically_derived]
            #[doc(hidden)]
            impl ::core::convert::From<MAX_RESPONSE_INTERVAL_BLOCKSCall>
            for UnderlyingRustTuple<'_> {
            ...
            #[doc(hidden)]
            impl ::core::convert::From<UnderlyingRustTuple<'_>>
            for MAX_RESPONSE_INTERVAL_BLOCKSCall {
                fn from(tuple: UnderlyingRustTuple<'_>) -> Self {
                    Self {}
                }
            }
        }
        {
            ...
            #[automatically_derived]
            #[doc(hidden)]
            impl ::core::convert::From<MAX_RESPONSE_INTERVAL_BLOCKSReturn>
            for UnderlyingRustTuple<'_> {
            ...
            #[doc(hidden)]
            impl ::core::convert::From<UnderlyingRustTuple<'_>>
            for MAX_RESPONSE_INTERVAL_BLOCKSReturn {
                fn from(tuple: UnderlyingRustTuple<'_>) -> Self {
                    Self { _0: tuple.0 }
                }
            }
...
```*/
    ...
    const _: () = {
        use alloy::sol_types as alloy_sol_types;
        {
            ...
            #[automatically_derived]
            #[doc(hidden)]
            impl ::core::convert::From<taskWasRespondedCall>
            for UnderlyingRustTuple<'_> {
        ...
        }
        {
            ...
            #[automatically_derived]
            #[doc(hidden)]
            impl ::core::convert::From<taskWasRespondedReturn>
            for UnderlyingRustTuple<'_> {
                ...
                },
                {
                    fn deregisterOperatorFromAVS(
                        ...
                        <deregisterOperatorFromAVSCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                HelloWorldServiceManagerCalls::deregisterOperatorFromAVS,
                            )
                    }
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct HelloWorldServiceManagerInstance<
        T,
        P,
        N = alloy_contract::private::Ethereum,
    > {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    > HelloWorldServiceManagerInstance<T, P, N> {
        ...
        pub fn MAX_RESPONSE_INTERVAL_BLOCKS(
            ...
            self.call_builder(
                &MAX_RESPONSE_INTERVAL_BLOCKSCall {
                },
            )
        }
